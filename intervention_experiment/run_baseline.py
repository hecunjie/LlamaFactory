...
def parse_args():
    parser = argparse.ArgumentParser(description="Run GSM8K baseline decoding experiment.")
    parser.add_argument("--model_name_or_path", type=str, required=True)
    parser.add_argument("--output_path", type=str, default="intervention_experiment/results/baseline.jsonl")
...
def main():
    ...
    run_experiment(exp_args, method="baseline")
