...
from ..sft.metric import ComputeAccuracy, ComputeExactMatch, ComputeSimilarity, eval_logit_processor
...
def run_distill(
    ...
    training_args.remove_unused_columns = training_args.remove_unused_columns

    # Metric utils (same as SFT workflow)
    metric_module = {}
    ...
    if is_transformers_version_greater_than("4.58.0"):
        ...
        all_eos_ids = [tokenizer.eos_token_id] + [i for i in (extra_ids or []) if i != -1]
    ...
    from .trainer_sft import DistillationTrainer
